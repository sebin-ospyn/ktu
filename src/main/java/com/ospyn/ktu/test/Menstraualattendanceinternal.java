...
import com.ospyn.ktu.view.ViewMenstrualattendanceInternal;
import com.relevantcodes.extentreports.LogStatus;

public class Menstraualattendanceinternal extends DriverConfig {
	ViewMenstrualattendanceInternal attendanceInternalMenstrual;
...
public Menstraualattendanceinternal() throws IOException
{
	/*initializing..
...
//	 */
	...
	driver=getDriver();
	report=Login.report;
	attendanceInternalMenstrual=new ViewMenstrualattendanceInternal(driver);
}
...
public void click_student_attandance_internal() throws InterruptedException, AWTException {
	...
	branches=ViewMenstrualattendanceInternal.Branchnames;
...
public void user_click_Internals_Button(String branchname)throws Exception
{
	...
	try
	{
//		String details="2023 - 2024,#B.Tech,#Full Time,#S5,#Pursuing Students,#Regular";
...
public void user_fetch_course_code_Faculty_Id() throws InterruptedException
{
	...
	faculties=ViewMenstrualattendanceInternal.facultyids;

	System.out.println("faculties are");
	System.out.println("**************");
	for (String element : ViewMenstrualattendanceInternal.batchnames)
...
public void user_navigate_to_student_details() throws InterruptedException{
	...
	report.beginTest("<b>"+testName[0]+"<br />"+testName[1]+"</b><br /><br /><i>User fetch student details to an arraylist</i>");
...
public void reading_Students() throws InterruptedException, AWTException, IOException
{
	...
	studentData=ViewMenstrualattendanceInternal.getStudentData();
...
public void User_login_as_Staff_Advisor() throws InterruptedException{
	...
	System.out.println(ViewMenstrualattendanceInternal.StaffAdvisorId.get(0));
	loginUser(ViewMenstrualattendanceInternal.StaffAdvisorId.get(0));
