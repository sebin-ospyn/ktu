...
import com.ospyn.ktu.view.ViewResultCorrection1;
import com.relevantcodes.extentreports.LogStatus;

public class ResultCorrection1 extends DriverConfig {
	// creating reference for Login
	static ViewLogin login;
	
	
	// creating reference to ViewCourseMapping
		ViewResultCorrection1 ResultCorrectionView;
	...
	// Creating static variable for adding details to log
		...
		String[] testName;
		public ResultCorrection1() throws Exception {

			report = Login.report;
			screenshot = new Screenshot();
			driver = getDriver();
			ResultCorrectionView = new ViewResultCorrection1(driver);
		}
...
//		ViewResultCorrection1 vr= new ViewResultCorrection1(driver);
		ResultCorrectionView.login();
