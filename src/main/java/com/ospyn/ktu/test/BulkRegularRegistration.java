...
import com.ospyn.ktu.view.ViewBulkRegularExamRegistration;
import com.relevantcodes.extentreports.LogStatus;

public class BulkRegularRegistration extends DriverConfig{

	//creating reference to ViewCourseSelection
	static ViewBulkRegularExamRegistration bulkRegularRegistrationView;
...
//	ViewCommonUtil CommonUtilView =new ViewCommonUtil(driver);
	...
	public BulkRegularRegistration()
	{
		/*initializing..
...
//		 */
		...
		driver=getDriver();
		bulkRegularRegistrationView=new ViewBulkRegularExamRegistration(driver);
		studentData=ViewBulkRegularExamRegistration.getStudentData();
	...
	@Test
	public void search_Students() throws InterruptedException, AWTException, IOException
	{
		report.beginTest("<b>"+testName[0]+"<br />"+testName[1]+"</b><br /><br /><i>searching students in student details</i>");
		bulkRegularRegistrationView.sudentDetailsSearch();
	...
	public void student_CourseRegisteration() throws InterruptedException, AWTException
	{
		...
		Testresult=bulkRegularRegistrationView.courseSelection1();
...
//		bulkRegularRegistrationView.getCollegeSaveButton().click();
		//	Due to failure of element click,just change the method,use click fn in commonUtilView file
 		((JavascriptExecutor) driver).executeScript("arguments[0].click();", bulkRegularRegistrationView.getCollegeSaveButton());
	...
	public void feeCollectedVerified_Check(String regNo)throws Exception{
		...
		//String auto CompleteT ext= driver.findElement(By.xpath("//a[contains(text(),'No Record found')]")).getText();
	...
	@Test
	public void branch_Submission() throws InterruptedException, AWTException {
		bulkRegularRegistrationView.clearall();


		report.beginTest("<b>"+testName[0]+"<br />"+testName[1]+"</b><br /><br /><i>user clicks on submit button</i>");
		Testresult=bulkRegularRegistrationView.examSubmission();
		while(Testresult) {
			Thread.sleep(2000);
			Thread.sleep(500);
			bulkRegularRegistrationView.submissionErrorMsg();
			Testresult=bulkRegularRegistrationView.examSubmission();
			Thread.sleep(1000);
		}
	...
	@Test
	public void examCredit_Value() throws Exception {

		report.beginTest("<b>"+testName[0]+"<br />"+testName[1]+"</b><br /><br /><i>user reads the maximum credit limit from scheme</i>");
	    bulkRegularRegistrationView.readingSemCredits();
		details="maximum credit is read from scheme";
	}
	...
	public void endTest() throws IOException
	{
		...
		String fileName=System.getProperty("user.dir")+"/target/Regular_Exam_Registration_"+dtf.format(now)+".html";
