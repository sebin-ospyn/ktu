...
import com.ospyn.ktu.view.ViewLpGrade;
import com.relevantcodes.extentreports.LogStatus;

public class Database extends DriverConfig {
	// creating reference for Login
	static ViewLogin login;

	ViewLpGrade LpGradeview;
	ViewCommonUtil cu;
	...
	public Database() throws Exception {
		...
		driver = getDriver();
		LpGradeview = new ViewLpGrade(driver);
//					ViewCommonUtil.readFromExcel("PARAMETER_LISTING.xlsx","LowPass");
	...
	@Test
	public void Login_as_AdExa() throws Exception {

		report.beginTest(
				"<b>" + testName[0] + "<br />" + testName[1] + "</B><br /><br /> User login as college admin ");
		LpGradeview.loginasStudent();
//		String ro = ViewCommonUtil.connectDBFetchSingleData();
//		System.out.println(ro);
//		ViewCommonUtil.writeToExcel("PARAMETER_LISTING.xlsx", "TestDatabase", "second", ro);
//					ViewCommonUtil.connectDB2();
		String s = ViewCommonUtil.readExcelColumHeader("PARAMETER_LISTING.xlsx", "TestDatabase", "Value", 1);
	...
	public void db() throws Exception {
		report.beginTest(
				"<b>" + testName[0] + "<br />" + testName[1] + "</B><br /><br /> User login as college admin ");
		LpGradeview.loginasStudent();
//	String l = ViewCommonUtil.connectDBFetchSingleDataFinal(
//				ViewCommonUtil.readExcelColumHeader("PARAMETER_LISTING.xlsx", "DataBase", "Value", 1),
//				ViewCommonUtil.readExcelColumHeader("PARAMETER_LISTING.xlsx", "DataBase", "Value", 2),
//				ViewCommonUtil.readExcelColumHeader("PARAMETER_LISTING.xlsx", "DataBase", "Value", 3),
//				ViewCommonUtil.readExcelColumHeader("PARAMETER_LISTING.xlsx", "DataBase", "Value", 4));
	String j = ViewCommonUtil.finaldb();
	System.out.println(j+"@");
	ViewCommonUtil.writeToExcel("PARAMETER_LISTING.xlsx","TestDatabase","second",j);
	Thread.sleep(2000);
	driver.findElement(By.xpath("//a[text()='Grievance Redressal Tickets']")).click();
	Thread.sleep(1000);
	ViewCommonUtil.enterStringValueinTextField(ViewCommonUtil.readExcelColumHeader("PARAMETER_LISTING.xlsx", "TestDatabase", "Value", 1),"//input[@id='searchForm_subject']");
