...
import com.ospyn.ktu.view.ViewAttendanceInternal3;
import com.relevantcodes.extentreports.LogStatus;

public class AttendanceInternal3 extends DriverConfig {
	ViewAttendanceInternal3 attendanceinternal;
...
public AttendanceInternal3() throws IOException
{
	/*initializing..
...
//	 */
	...
	driver=getDriver();
	report=Login.report;
	attendanceinternal=new ViewAttendanceInternal3(driver);
}
...
public void click_student_attandance_internal() throws InterruptedException, AWTException
{
	...
	branches=ViewAttendanceInternal3.Branchnames;
...
public void user_click_Internals_Button(String branchname)throws Exception
{
	...
	try
	{
//		String details="2023 - 2024,#B.Tech,#Full Time,#S3,#Pursuing Students,#Regular";
...
public void user_fetch_course_code_Faculty_Id() throws InterruptedException
{
	...
	faculties=ViewAttendanceInternal3.facultyids;

	System.out.println("faculties are");
	System.out.println("**************");
	for (String element : ViewAttendanceInternal3.batchnames)
...
//	String advisor="2022 - 2023,#B.Tech,#Regular";
	attendanceinternal.StaffAdvisor();
	details="User navigates to faculty and staff advisor selecting page";
}
...
//	String stringList="B.Tech Full Time 2019 Scheme";
	attendanceinternal.Schemeselection();
...
public void User_fetching_faculty_assignedcourses() throws InterruptedException{
	...
	attendanceinternal.facultylistingcourse();
...
public void User_login_as_Staff_Advisor() throws InterruptedException{
	...
	System.out.println(ViewAttendanceInternal3.StaffAdvisorId.get(0));
	loginUser(ViewAttendanceInternal3.StaffAdvisorId.get(0));
...
//	String advisorBatch="2023 - 2024,#B.Tech,#Full Time,#S3,#Pursuing Students,#Regular";
	attendanceinternal.advisorBatches();
	details="Faculty enter into course assigned page";
}
...
public void User_click_Student_Attendance_Internals_option() throws InterruptedException {
	...
	attendanceinternal.AttendanceInternals();
