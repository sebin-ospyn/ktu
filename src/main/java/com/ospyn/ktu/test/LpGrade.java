...
public class LpGrade extends DriverConfig{
	...
	// creating reference for Login
		...
		// Creating static variable for adding details to log
			...
			public LpGrade() throws Exception {
			...
			@Test
			public void applyingLP() throws InterruptedException
			{
				report.beginTest("<b>" + testName[0] + "<br />" + testName[1] + "</B><br /><br /> User login as college admin ");
				LpGradeview.applyLP();
				details = "User logging in as adexam";
			...
			@Test
			public void LPHappyFlow() throws Exception
			{
				report.beginTest("<b>" + testName[0] + "<br />" + testName[1] + "</B><br /><br /> User login as college admin ");
				
				LpGradeview.loginasStudent();
				String GradeBefore = LpGradeview.checkLPGradeasStudent();
				LpGradeview.logout();
				
				LpGradeview.loginasAdExam();
//				LpGradeview.applyLP();
				LpGradeview.process();
				LpGradeview.postprocess();
				LpGradeview.publish();
				LpGradeview.logout();
				
				LpGradeview.loginasStudent();
				String GradeAfter = LpGradeview.checkLPGradeasStudent();
				System.out.println(GradeBefore+"@test");
				System.out.println(GradeAfter+"@test");
			...
			public void tes() throws Exception
			{
				report.beginTest("<b>" + testName[0] + "<br />" + testName[1] + "</B><br /><br /> User login as college admin ");
				LpGradeview.loginasStudent();
				LpGradeview.CheckAvailedNumber();
