...
public class TestNGClass {
	...
	{    	
		...
		System.out.println("No of colleges "+(columns-1));

		//storing  the module names in an array
		String testNames[]= {"XMLHFCourseSelection.xml","XMLHFCourseMapping.xml","XMLBulkRegularRegistration.xml","XMLMenstrualAttendanceInternal.xml"};
