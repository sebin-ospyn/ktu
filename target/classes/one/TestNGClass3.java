...
//		String testNames[]= {"XMLHFCourseSelection.xml","XMLHFCourseMapping.xml","XMLBulkRegularRegistration.xml","XMLMenstrualAttendanceInternalFinal.xml"};
		String testNames[]= {"XMLMenstrualAttendanceInternalFinal.xml"};
...
//		//Running each module for each college
		...
		{
			testng=new TestNG();
			String suiteName="src/main/resources/"+testNames[tests];
...
//		*************************************************************************************
//		Calling a method from class TestNGClas2 for running scripts
		TestNGClass2.runLogic();
		
		
		
//		*************************************************************************************
//		Method for adding another xml files
		String testnames2[]= {"XMLHFHallTicket.xml","XMLabsenteeMalpracticeBulk.xml"};
//		String testnames2[]= {"XMLabsenteeMalpracticeBulk.xml"};
		for(int tests=0;tests<testnames2.length;tests++)
		{
			testng=new TestNG();
			String suiteName="src/main/resources/"+testnames2[tests];
			System.out.println(suiteName);
			suites.clear();
			suites.add(suiteName);
			System.out.println("Suites are "+suites);
